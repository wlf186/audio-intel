...
@pytest.mark.parametrize(
    ("describe", "expected"),
    (
        ("v0.1.5-0-g3a478297", "0.1.5"),
        ("v0.1.5-0-g3a478297-dirty", "0.1.5+0.g3a478297.dirty"),
        ("v0.1.5-3-g8adfe461", "0.1.5+3.g8adfe461"),
        ("v0.1.5-3-g8adfe461-dirty", "0.1.5+3.g8adfe461.dirty"),
        ("v0.1.4-3-g8adfe461", "0.1.5+g8adfe461"),
        ("8adfe461", "0.1.5+g8adfe461"),
        ("8adfe461-dirty", "0.1.5+g8adfe461.dirty"),
        (None, "0.1.5"),
        ("not-a-version", "0.1.5"),
    ),
)
