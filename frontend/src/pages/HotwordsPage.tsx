...
function displayName(item:HotwordList,t:TFunction){if(item.id==='hotwords_voiceprint_people')return t('hotwords.systemNames.full');if(item.id==='hotwords_voiceprint_people_short')return t('hotwords.systemNames.short');return item.name}
