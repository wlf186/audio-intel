...
export function AsrPage({jobs,refresh,selectedJobId,onSelect,gpuAvailable}:{jobs:Job[];refresh:()=>void;selectedJobId?:string;onSelect:(j:Job)=>void;gpuAvailable?:boolean}){
