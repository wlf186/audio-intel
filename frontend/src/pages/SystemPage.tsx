...
function MobileProjectIdentityNotice(){
 const {t}=useTranslation()
 return <details className="mobile-project-identity"><summary>{t('shell.unofficial')}</summary><p>{t('shell.unofficialDetail')}</p></details>
}
