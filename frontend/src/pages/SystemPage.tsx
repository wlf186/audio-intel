...
function ProjectIdentityNotice(){
 const {t}=useTranslation()
 return <aside className="project-identity" aria-label={t('system.projectIdentityTitle')}><strong>{t('system.projectIdentityTitle')}</strong><p>{t('system.projectIdentityBody')}</p></aside>
}
