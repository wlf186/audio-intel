...
import type {Capabilities,Health,Job,JobResult,ResultRevealRequest,VoiceprintPerson} from './lib/types'
...
export default function App(){
 ...
 useEffect(()=>{void Promise.all([api.capabilities().then(setCapabilities),refreshVoiceprints()]).catch(error=>setConnectionError((error as Error).message))},[refreshVoiceprints])
