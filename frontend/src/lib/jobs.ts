...
const stageCodes=new Set(['tts_chunk_retry','document_synthesis','document_retry_wait','queued','starting','loading_tts_model','waiting_for_gpu','preparing_voice_clone','synthesis','writing_output','decoding_audio','vad','diarization','transcription','alignment','merging','completed','succeeded','failed','cancelled','cancelling'])
const unitCodes=new Set(['attempt','document_section','text_chunk','audio_chunk','codec_frame','output_token','model_layer','item','batch'])
