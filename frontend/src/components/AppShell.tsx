...
function UnofficialFooterNotice(){
 const {t}=useTranslation()
 const tooltipId='project-identity-tooltip'
 return <span className="footer-identity"><button type="button" className="footer-id" aria-describedby={tooltipId}>{t('shell.unofficial')}</button><span id={tooltipId} role="tooltip">{t('shell.unofficialDetail')}</span></span>
}
